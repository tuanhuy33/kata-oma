...
WebUI.setText(findTestObject('Object Repository/Username Field'), 'usernameVariable')
WebUI.setText(findTestObject('Object Repository/Password Field'), 'passwordVariable')
