...
WebUI.setText(findTestObject('Object Repository/Username Field'), 'your_username')
WebUI.setText(findTestObject('Object Repository/Password Field'), 'your_password')

// Click the login button
WebUI.click(findTestObject('Object Repository/Login Button'))

// Verify that the appointment div exists
WebUI.verifyElementPresent(findTestObject('Object Repository/Appointment Div'), 10)
