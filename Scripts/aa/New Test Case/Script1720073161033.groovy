...
WebUI.click(findTestObject('Object Repository/Page_Login/button_Make Appointment'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Home/div_Appointment'))
